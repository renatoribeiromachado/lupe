...
<html>
    ...
    <body style="background:#fbfbfb;">
        ...
        <div class="container-fluid">
            <div class="row m-1" style="padding-top: 100px;">
                
                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 text-center">
                    <img src="<?= base_url(); ?>/public/assets/img/logo-lupecloud.png" class="img-fluid" alt="Lupe Cloud" width="350px"/>
                </div>
             
                <div class="col-md-12 col-sm-12 col-lg-4 offset-lg-4 rounded-3 shadow-lg bg-light media-form-login mt-3">
                    ...
                    <form action="login\logar" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="email" class="form-control" value="<?= old('email'); ?>" placeholder="Digite o login de usuário"/>                                        
                        </div>

                        <!-- PASSWORD -->
                        <div class="input-group">
                            <div class="input-group-text"><i class="fa fa-key"></i></div>
                            <input type="password" name="password" class="form-control" maxlength="6" placeholder="Informe a senha"/>
                        </div>
